...
void deadbeef_command(char *);
void write_raw_test_command(char *);
...
command_t commands[] = {
  ...
  {"deadbeef",deadbeef_command},
  {"write_raw_test",write_raw_test_command},
  {0,0}
};
...
void __attribute__((weak)) write_raw_test_command(char *arguments) {
  printf("In weak raw command test \n\r");
  printf("OK\n\r");
}

void __attribute__((weak)) deadbeef_command(char *arguments) {
  printf("Not real beef\n\r");
  printf("OK\n\r");
}
